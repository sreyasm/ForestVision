...
bool RF95_init(SPI_HandleTypeDef, GPIO_TypeDef*);
bool send(SPI_HandleTypeDef, GPIO_TypeDef*, const uint8_t*);
void setModeRx(SPI_HandleTypeDef, GPIO_TypeDef*);
void setModeTx(SPI_HandleTypeDef, GPIO_TypeDef*);
