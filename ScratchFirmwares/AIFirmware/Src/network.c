...
#define AI_NETWORK_MODEL_SIGNATURE     "b998443b04b55fd66fa3377f45d4435c"
...
#define AI_TOOLS_DATE_TIME   "Tue Dec 10 01:53:05 2019"
...
AI_STATIC ai_array conv2d_3_bias_array;   /* Array #7 */
AI_STATIC ai_array conv2d_3_weights_array;   /* Array #8 */
...
AI_STATIC ai_array input_1_output_array;   /* Array #13 */
...
AI_STATIC ai_array dense_1_nl_output_array;   /* Array #18 */
AI_STATIC ai_array dense_2_output_array;   /* Array #19 */
AI_STATIC ai_array dense_2_nl_output_array;   /* Array #20 */
...
AI_STATIC ai_tensor conv2d_3_bias;   /* Tensor #7 */
AI_STATIC ai_tensor conv2d_3_weights;   /* Tensor #8 */
...
AI_STATIC ai_tensor input_1_output;   /* Tensor #13 */
...
AI_STATIC ai_tensor conv2d_3_output0;   /* Tensor #17 */
AI_STATIC ai_tensor dense_1_output;   /* Tensor #18 */
AI_STATIC ai_tensor dense_1_nl_output;   /* Tensor #19 */
AI_STATIC ai_tensor dense_2_output;   /* Tensor #20 */
AI_STATIC ai_tensor dense_2_nl_output;   /* Tensor #21 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 64, 21, 2), AI_STRIDE_INIT(4, 4, 4, 256, 5376),
  1, &conv2d_3_scratch0_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_2_scratch0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 47, 2), AI_STRIDE_INIT(4, 4, 4, 128, 6016),
  1, &conv2d_2_scratch0_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_scratch0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 98, 2), AI_STRIDE_INIT(4, 4, 4, 64, 6272),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 512, 1, 1, 1), AI_STRIDE_INIT(4, 4, 2048, 2048, 2048),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 6400, 512, 1, 1), AI_STRIDE_INIT(4, 1, 3200, 1638400, 1638400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 3, 100, 100), AI_STRIDE_INIT(4, 4, 4, 12, 1200),
  1, &input_1_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_1_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 49, 49), AI_STRIDE_INIT(4, 4, 4, 64, 3136),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 6400, 1, 1), AI_STRIDE_INIT(4, 4, 4, 25600, 25600),
  1, &conv2d_3_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_1_output_array.data = AI_PTR(activations + 12544);
    conv2d_1_output_array.data_start = AI_PTR(activations + 12544);
    conv2d_2_output_array.data = AI_PTR(activations + 166208);
    conv2d_2_output_array.data_start = AI_PTR(activations + 166208);
    conv2d_3_output_array.data = AI_PTR(activations + 10752);
    conv2d_3_output_array.data_start = AI_PTR(activations + 10752);
    ...
    dense_2_output_array.data = AI_PTR(activations + 2048);
    dense_2_output_array.data_start = AI_PTR(activations + 2048);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_2_bias_array.data = AI_PTR(weights + 1736896);
    dense_2_bias_array.data_start = AI_PTR(weights + 1736896);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 1734848);
    dense_2_weights_array.data_start = AI_PTR(weights + 1734848);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 1732800);
    dense_1_bias_array.data_start = AI_PTR(weights + 1732800);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 94400);
    dense_1_weights_array.data_start = AI_PTR(weights + 94336);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(weights + 94080);
    conv2d_3_bias_array.data_start = AI_PTR(weights + 94080);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(weights + 20352);
    conv2d_3_weights_array.data_start = AI_PTR(weights + 20352);
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(weights + 20224);
    conv2d_2_bias_array.data_start = AI_PTR(weights + 20224);
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(weights + 1792);
    conv2d_2_weights_array.data_start = AI_PTR(weights + 1792);
